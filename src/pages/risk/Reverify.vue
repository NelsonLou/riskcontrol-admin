      ...
      <el-table-column label="操作" width="220" fixed="right">
        <template scope="scope" style="text-align:center" class="dobtn">
          <div scope="scope" class="dobox">
            <el-button size="small" icon="edit" type="info">复审</el-button>
...
<script>
import Reverify from './formData/reverify'
...
export default {
  ...
  methods: {
    ...
    handleGetTableData() {
      ...
      fn.handleGetTableData(api.risk.reverfiyList, that.para, res => {
    ...
    batchRemove() {
      ...
      this.$confirm('确认删除选中记录吗？', '提示', {
        ...
        fn.handleRemoveTableData(api.risk.reverfiyRemove, ids, (res) => {
           that.loading = false
           this.handleGetTableData()
        })
      }).catch(() => {
